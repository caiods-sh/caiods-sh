...
<text align="center">i've always been a technology lover, i was a video editor, so, I've used many different programs and technologies, I liked it a lot, but i found my real vocation when i coded my first project in Python, the feeling of completing a challenge, and resolve problems is so satisfying, after that i started to study coding a lot and joined in Trybe Web Developer course, since then I have done a several projects in JavaScript/ReactJS.</text>
<br></br>
